...
export default class Personas extends React.Component {
  ...
  findDetalle = id => {
    this.setState({ ...this.state, modalTitle: "Actualizar persona" }, () =>
      ...
      <Layout>
        <TheHeader>
          ...
          <Col span={12} align="right">
            <Button type="primary" onClick={this.showModalCarga}>
              {" "}
              Cargar Archivo{" "}
            </Button>
          </Col>
        ...
        >
          <Upload {...props}>
            <h3>
              Para añadir datos en masa, seleccione un archivo txt que contenga
              la información que desea cargar.
            </h3>
